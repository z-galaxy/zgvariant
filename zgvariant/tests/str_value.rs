use zgvariant::{LE, Value, serialized::Context, to_bytes};
...
fn str_value() {
    ...
    basic_type_test!(LE, string, 12, String, 1);

    let string = "hello world";
    basic_type_test!(LE, string, 12, &str, 1);
