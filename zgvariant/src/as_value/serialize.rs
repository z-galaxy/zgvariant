...
///
/// ```
/// # use zgvariant::{to_bytes, serialized::Context, as_value::Serialize, LE};
/// #
...
/// Serialize a value as a [`enum@crate::Value`].
...
/// Serialize an optional value as a [`enum@crate::Value`].
